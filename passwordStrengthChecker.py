...
'''
checkPasswordStrength("ghghjghj")
checkPasswordStrength("          ")
checkPasswordStrength("avc5*A")
checkPasswordStrength("avc5*A7643")
checkPasswordStrength("avc5*A7643fg")
checkPasswordStrength("avc5*A7643fa(hj")
checkPasswordStrength("bvvv")
checkPasswordStrength("avc5*A76bbb43fa(hj")
checkPasswordStrength(" uuy de ()(")
checkPasswordStrength(" uy de ()(673A")
checkPasswordStrength("ghgdhgdhgdhA*()245")
checkPasswordStrength("ghgdhgdhgdhA*()245sgsdsafa")
checkPasswordStrength("qwertncks12*AnBF")
checkPasswordStrength("")
checkPasswordStrength("6Rlshorse781*") '''
